...
class WhiteDuck5 extends Duck5 { }

class ThunderDuck5 extends Duck5 { }

class RubberDuck5 extends Duck5 {
    RubberDuck5() {
        flyItem = new DisFlyItem();
    }
}

class RubberDuck6 extends Duck5 {
    RubberDuck6() {
        flyItem = new DisFlyItem();
    }
}
...
public class java7 {
    public static void main(String[] args) {
        ThunderDuck5 thunderDuck = new ThunderDuck5();
        thunderDuck.fly();
        // 출력 : 오리가 날개로 날아갑니다.

        WhiteDuck5 whiteDuck = new WhiteDuck5();
        whiteDuck.fly();
        // 출력 : 오리가 날개로 날아갑니다.

        RubberDuck5 rubberDuck1 = new RubberDuck5();
        rubberDuck1.fly();
        // 출력 : 저는 날 수 없어요. ㅜㅠ

        RubberDuck6 rubberDuck2 = new RubberDuck6();
        rubberDuck2.fly();
        // 출력 : 저는 날 수 없어요. ㅜㅠ
